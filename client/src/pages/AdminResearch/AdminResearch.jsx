...
const AdminResearch = () => {
    ...
    const fetchResearchData = async () => {
        try {
            const response = await fetch("http://13.60.226.150:5000/api/research");
    ...
    const handleUpdateResearch = async () => {
        try {
            const response = await fetch(`http://13.60.226.150:5000/api/research/${editResearch._id}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleDeleteResearch = async (id) => {
        try {
            const response = await fetch(`http://13.60.226.150:5000/api/research/${id}`, {
                method: 'DELETE',
            });
            if (response.ok) fetchResearchData();
        } catch (error) {
